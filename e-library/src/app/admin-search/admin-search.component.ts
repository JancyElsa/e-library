...
// onEdit(book:any)
// {
//   let updateBook:Ibook=
//     {
//       bookId:this.addBookForm.value.bookId.setValue(book.bookId),
//       bookTitle:this.addBookForm.value.bookTitle.setValue(book.bookTitle),
//       bookDescription:this.addBookForm.value.bookDescription.setValue(book.bookDescription),
//       authorName:this.addBookForm.value.authorName.setValue(book.authorName),
//       availBooks:this.addBookForm.value.availBooks.setValue(book.availBooks)
//     }
